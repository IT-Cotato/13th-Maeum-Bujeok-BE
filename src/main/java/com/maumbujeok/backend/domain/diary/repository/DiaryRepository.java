...
public interface DiaryRepository extends JpaRepository<Diary, Long> {
    ...
    boolean existsByMemberPhoneNumberAndRecordedDateGreaterThanEqualAndRecordedDateLessThanAndBurnedAtIsNull(
            String phoneNumber,
            LocalDate recordedDate,
            LocalDate endedAtExclusive
    );
    ...
    long countByMemberPhoneNumberAndRecordedDateGreaterThanEqualAndRecordedDateLessThanAndBurnedAtIsNull(
            String phoneNumber,
            LocalDate recordedDate,
            LocalDate endedAtExclusive
    );
    ...
    List<Diary> findAllByMemberPhoneNumberAndRecordedDateGreaterThanEqualAndRecordedDateLessThanAndBurnedAtIsNullOrderByRecordedDateAscIdAsc(
            String phoneNumber,
            LocalDate recordedDate,
            LocalDate endedAtExclusive
    );

    List<Diary> findAllByMemberPhoneNumberAndRecordedDateAndBurnedAtIsNullOrderByRecordedDateAscIdAsc(
            String phoneNumber,
            LocalDate recordedDate
    );
